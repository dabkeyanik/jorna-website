        ...
        <div className="mx-auto w-[min(1080px,100%)]">
          ...
          <div className="mt-12 grid h-[220px] grid-cols-3 gap-3 md:gap-4">
            <div className="col-span-2 overflow-hidden rounded-2xl bg-panel">
              ...
              <img
                src="https://images.unsplash.com/photo-1772127822552-ce9ef537bdcf?w=900&h=440&fit=crop&auto=format"
            ...
            <div className="flex flex-col gap-3 md:gap-4">
              <div className="flex-1 overflow-hidden rounded-2xl bg-panel">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="https://images.unsplash.com/photo-1505932794465-147d1f1b2c97?w=400&h=200&fit=crop&auto=format"
              ...
              <div className="flex-1 overflow-hidden rounded-2xl bg-panel">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="https://images.unsplash.com/photo-1731441326210-bfcb6595e93a?w=400&h=200&fit=crop&auto=format"
        ...
        <div className="mx-auto w-[min(1080px,100%)]">
          <div className="overflow-hidden rounded-2xl bg-maroon shadow-[0_32px_64px_-20px_rgba(74,11,26,0.4)] md:grid md:grid-cols-2">
            <div className="h-56 bg-maroon-deep md:h-auto md:min-h-[320px]">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="https://images.unsplash.com/photo-1772127822562-a898d9f5733c?w=800&h=640&fit=crop&auto=format"
            ...
            <div className="flex flex-col justify-center p-8 md:p-12">
              ...
              <div className="mt-8">
                <Link
                  href={user ? "/vendor-profile" : "/login?mode=register"}
