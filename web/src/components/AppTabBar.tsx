...
//
//   Client: Home · Marketplace · Build · Dashboard · Needs you · Messages · Profile
...
const CLIENT_TABS: Tab[] = [
  ...
  { href: "/bundles", label: "Dashboard", icon: icon(I.bundles), match: ["/bundles", "/bundle", "/book", "/events", "/event"] },
  NEEDS_YOU,
